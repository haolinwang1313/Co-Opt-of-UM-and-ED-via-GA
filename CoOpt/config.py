...
CELL_BOUNDS = {
    "coverage_factor": (0.8, 1.05),
    "floor_base": (8, 11),
    "floor_gradient": (-0.15, 0.15),
    "podium_ratio": (0.25, 0.4),
    "green_ratio": (0.0, 0.05),
    "blue_ratio": (0.0, 0.01),
    "road_width_factor": (0.8, 1.1),
    "road_grid_density": (0.8, 1.1),
}

GLOBAL_BOUNDS = {
    "target_far": (2.4, 2.8),
    "industrial_quota": (0.4, 0.6),
    "green_network_continuity": (0.6, 0.85),
    "bus_ring_strength": (0.1, 0.4),
}

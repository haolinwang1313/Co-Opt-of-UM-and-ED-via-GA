...
BASE_SCENARIOS = {
    "S1": {"coverage": 1.05, "floor_high": 11},
    "S2": {"coverage": 1.06, "floor_high": 11},
}
SEEDS = [101, 202, 303]
POP = 80
N_GEN = 60
...
def main() -> None:
    ...
    for scenario, info in BASE_SCENARIOS.items():
        ...
        summary.append({
            ...
            "feasible_count": analysis.get("count", 0),
            "dev_ratio_mean": analysis.get("developed_ratio_stats", {}).get("mean"),
            "energy_mean": analysis.get("energy_stats", {}).get("mean"),
        })
